...
> See [`cases/performing-rigs/docs/investigations/protocol-pipeline.md`](../../docs/investigations/protocol-pipeline.md)
> for the current, corrected picture and
> [`cases/performing-rigs/docs/investigations/protocol-harness-results.md`](../../docs/investigations/protocol-harness-results.md)
