...
This merges `cases/performing-rigs/research/autopilot_static_inventory/open-questions.md` (v0.3,
...
[`cases/performing-rigs/status.md`](../../status.md) instead — this file is
...
8. **Reconcile Remote-transmitted packets not accepted by the visible
   ...
   [`cases/performing-rigs/status.md`](../../status.md)'s current blocker).
...
10. ~~What do `0x5274` and `0x5448` actually do?~~ **Largely resolved
    ...
    disagreement" section and [`cases/performing-rigs/status.md`](../../status.md)'s
    current blocker.
11. ~~Is the `0x801c` ARM/A32-mode lift a real Macaw/dismantle discovery
    ...
    and [`docs/tooling/tool-selection.md`](../../../../docs/tooling/tool-selection.md).
