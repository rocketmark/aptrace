...
**Authoritative source**: `cases/performing-rigs/research/autopilot_static_inventory/protocol-bidirectional.md`
...
AutoPilot parser (flash 0x8258)         <- one command byte confirmed
        ...
        |                                    cases/performing-rigs/docs/investigations/protocol-pipeline.md
...
transaction — see [`cases/performing-rigs/status.md`](../../status.md).
...
[`cases/performing-rigs/status.md`](../../status.md)), independently arrived at
