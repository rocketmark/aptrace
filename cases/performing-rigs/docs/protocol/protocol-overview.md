...
1. **`cases/performing-rigs/research/autopilot_static_inventory/`** — a purely static
...
**This directory (`cases/performing-rigs/docs/protocol/`) is the current, curated layer**: it
...
| [`open-questions.md`](open-questions.md) | Current, consolidated open questions (protocol-level; see [`cases/performing-rigs/status.md`](../../status.md) for harness-level blockers) |
...
dispatcher. See [`cases/performing-rigs/docs/investigations/protocol-pipeline.md`](../investigations/protocol-pipeline.md)
...
- `cases/performing-rigs/research/autopilot_static_inventory/commands.csv`,
  `cases/performing-rigs/research/autopilot_static_inventory/responses.csv`,
  `cases/performing-rigs/research/autopilot_static_inventory/pending-writes.csv` — the primary
...
- `cases/performing-rigs/research/autopilot_static_inventory/*.md` — the narrative research notes
