...
**Authoritative source**: `cases/performing-rigs/research/autopilot_static_inventory/event-map.md`,
...
and [`cases/performing-rigs/status.md`](../../status.md). No other event's
...
[`cases/performing-rigs/status.md`](../../status.md)).
...
Full producer table: `cases/performing-rigs/research/autopilot_static_inventory/pending-writes.csv`.
