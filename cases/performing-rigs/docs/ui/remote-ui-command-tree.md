...
`cases/performing-rigs/docs/ui/user-guide-workflows.md`, `cases/performing-rigs/docs/ui/action-command-map.md`,
`cases/performing-rigs/docs/replacement/manual-to-firmware-traceability.md`/`.json`,
`cases/performing-rigs/docs/replacement/four-firmware-contract.md`/`.json`,
`cases/performing-rigs/docs/hardware/hardware-reference.md`, `cases/performing-rigs/docs/protocol/*`,
`cases/performing-rigs/docs/investigations/*`.

**Machine-readable companion (authoritative)**: [`cases/performing-rigs/research/generated/remote-ui-command-tree.json`](../../research/generated/remote-ui-command-tree.json) — 21 nodes, 50 edges (CLEAR split into two edges by a later closure pass — see "Unresolved UI → command edges," below).
...
`cases/performing-rigs/docs/ui/user-guide-workflows.md#13` (firmware update via NOXON
...
[`cases/performing-rigs/research/generated/manual-to-firmware-traceability.json`](../../research/generated/manual-to-firmware-traceability.json)
(`MAN-UPDATE-001`).
