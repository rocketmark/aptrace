...
built from. `cases/performing-rigs/docs/firmware/firmware-inventory.md` separately notes that an
...
(`cases/performing-rigs/research/runs/ghidra_cache/mando868/static_export.json`, 211 strings
...
4. **`[firmware, CONFIRMED]`** A per-motor settings page (header
   ...
   `cases/performing-rigs/docs/replacement/manual-to-firmware-traceability.md`
...
- **`"E1,0,|"` / `"E1,400000,|"` / `"E1,1500,|"` / `"E1,10000,|"`** — look
  ...
  [`cases/performing-rigs/docs/protocol/command-inventory.md`](../protocol/command-inventory.md)'s
