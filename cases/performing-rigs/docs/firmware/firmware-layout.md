...
Source images: `~/github/aptrace/cases/performing-rigs/research/firmware/vendor-package/` (originals, untouched).
Working copies + hashes: `~/github/aptrace/cases/performing-rigs/research/firmware/originals/` (see `SHA256SUMS.txt`).
...
## Flashing mechanism (`cases/performing-rigs/research/firmware/vendor-package/update_firmware.bat`)
...
[`cases/performing-rigs/docs/hardware/hardware-reference.md`](../hardware/hardware-reference.md).
...
```
python3 tools/vector_scan.py cases/performing-rigs/research/firmware/originals/firmware_autopilot868.bin \
