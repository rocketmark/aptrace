...
**Machine-readable companion (authoritative)**: [`cases/performing-rigs/research/generated/manual-to-firmware-traceability.json`](../../research/generated/manual-to-firmware-traceability.json), 50 atomic requirements (a later bounded closure pass split CLEAR into `MAN-AUTO-006`/`MAN-AUTO-009` — see "Unresolved core Auto Mode edges," below).
...
[`cases/performing-rigs/docs/ui/remote-ui-command-tree.md`](../ui/remote-ui-command-tree.md)'s
...
- `cases/performing-rigs/docs/ui/action-command-map.md` — the `'+'` row's "remains the working
...
- `cases/performing-rigs/docs/investigations/manual-mode-and-limits.md`'s "UNKNOWN" tag on the
...
- `cases/performing-rigs/docs/ui/user-guide-workflows.md`'s motor-configuration-fields hedge
...
- 6 `NO_FIRMWARE_EVIDENCE` rows (most RF/settings screens, factory
  ...
  `cases/performing-rigs/docs/ui/remote-ui-command-tree.md`.)
