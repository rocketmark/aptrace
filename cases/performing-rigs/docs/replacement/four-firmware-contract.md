...
**Machine-readable companion**: [`cases/performing-rigs/research/generated/four-firmware-contract.json`](../../research/generated/four-firmware-contract.json).
...
Compared `cases/performing-rigs/docs/ui/user-guide-workflows.md` and
`cases/performing-rigs/docs/ui/action-command-map.md` against the reconciled four-firmware
contract above and `cases/performing-rigs/docs/hardware/hardware-reference.md`. **No rewrite
performed** — output is a gap list only, in
[`cases/performing-rigs/research/generated/manual-traceability-gap-list.json`](../../research/generated/manual-traceability-gap-list.json).
