...
**Machine-readable companion**: [`cases/performing-rigs/research/generated/mando868-counterpart-audit.json`](../../research/generated/mando868-counterpart-audit.json).

## Method

Built primarily from canonical docs already covering the Remote side in
detail — `cases/performing-rigs/docs/ui/action-command-map.md`, `cases/performing-rigs/docs/protocol/command-
inventory.md`, `cases/performing-rigs/docs/protocol/bidirectional-protocol.md`,
`cases/performing-rigs/docs/investigations/manual-mode-and-limits.md`,
`cases/performing-rigs/docs/investigations/auto-mode-and-plus-command.md`,
`cases/performing-rigs/docs/investigations/motor-config-persistence.md`,
`cases/performing-rigs/docs/investigations/protocol-pipeline.md` — cross-checked against the
