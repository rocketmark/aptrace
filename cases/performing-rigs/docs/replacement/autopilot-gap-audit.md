...
**Machine-readable companion**: [`cases/performing-rigs/research/generated/autopilot-replacement-gaps.json`](../../research/generated/autopilot-replacement-gaps.json).

## Scope and sources

Evidence pulled from `cases/performing-rigs/status.md`, every file under
`cases/performing-rigs/docs/investigations/`, `cases/performing-rigs/docs/hardware/hardware-reference.md`, every file
under `cases/performing-rigs/docs/protocol/`, every file under `cases/performing-rigs/docs/ui/`, `cases/performing-rigs/docs/firmware/`, and
the AutoPilot868 semantic-pass artifacts (`cases/performing-rigs/research/generated/autopilot-semantic-pass1.jsonl`
...
absorbed into `cases/performing-rigs/docs/hardware/hardware-reference.md` (condensed feature
summary) and `cases/performing-rigs/docs/ui/user-guide-workflows.md`/`action-command-map.md`
...
- **This session's own semantic passes (3–9) already closed real,
  ...
  was in `cases/performing-rigs/docs/investigations/` before this audit's inputs existed. It is
