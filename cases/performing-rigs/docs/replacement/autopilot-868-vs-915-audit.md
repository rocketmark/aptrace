...
**Machine-readable companion**: [`cases/performing-rigs/research/generated/autopilot-868-vs-915-diff.json`](../../research/generated/autopilot-868-vs-915-diff.json).

AutoPilot868 is treated as the authoritative semantic/reference
baseline throughout (per `cases/performing-rigs/status.md`,
`cases/performing-rigs/docs/replacement/autopilot-gap-audit.md`,
`cases/performing-rigs/research/generated/autopilot-replacement-gaps.json`, every file under
`cases/performing-rigs/docs/investigations/` and `cases/performing-rigs/docs/protocol/`, and
`cases/performing-rigs/docs/hardware/hardware-reference.md`). AutoPilot915 is **not**
...
1. **Exhaustive raw byte diff** of the two firmware images
   (`cases/performing-rigs/research/firmware/originals/firmware_autopilot868.bin` vs
...
(`cases/performing-rigs/docs/replacement/autopilot-gap-audit.md`,
`cases/performing-rigs/research/generated/autopilot-replacement-gaps.json`) applies unchanged
