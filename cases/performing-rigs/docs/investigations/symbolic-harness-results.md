...
[`cases/performing-rigs/docs/investigations/symbolic-execution-results.md`](symbolic-execution-results.md)
and [`cases/performing-rigs/docs/investigations/protocol-harness-results.md`](protocol-harness-results.md)
...
- Every writable segment (RAM) starting at a *known* value (zero, matching
  ...
  assertion count. See
  [`docs/tooling/compact-ram-initialization.md`](compact-ram-initialization.md).
...
[`cases/performing-rigs/status.md`](../../status.md). The architecturally
