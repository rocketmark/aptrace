...
`../../cases/performing-rigs/research/autopilot_static_inventory/`'s independently-derived command table.
...
`../../cases/performing-rigs/research/autopilot_static_inventory/protocol-pipeline.md` models the dispatcher as a
...
values `../../cases/performing-rigs/research/autopilot_static_inventory/commands.md` independently assigned to these
...
"motor state" functions per `../../cases/performing-rigs/research/autopilot_static_inventory/
...
[cases/performing-rigs/roadmap.md](../../roadmap.md). (Briefly, as of this document: resolve
