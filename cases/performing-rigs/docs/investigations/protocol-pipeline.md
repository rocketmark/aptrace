...
(`cases/performing-rigs/research/autopilot_static_inventory/protocol-pipeline.md`, v0.1) read the
...
previously as `cases/performing-rigs/status.md`'s "A real calling-convention bug,
