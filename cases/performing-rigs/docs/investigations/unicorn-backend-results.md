...
[`tool-selection.md`](../../../../docs/tooling/tool-selection.md) for when to reach for this instead
...
machine = ConcreteMachine("cases/performing-rigs/research/firmware/originals/firmware_mando868.bin", mmio_size=0x4000000)
...
[`cases/performing-rigs/docs/investigations/auto-mode-and-plus-command.md`](../investigations/auto-mode-and-plus-command.md)'s
...
- LR is set to a real, harmless, *decodable* Thumb instruction (a
  ...
  theoretical ones (see `cases/performing-rigs/docs/investigations/auto-mode-and-plus-command.md`
...
(`cases/performing-rigs/status.md`'s "A real calling-convention bug, fixed") — use
...
[`cases/performing-rigs/docs/investigations/motor-subsystem-unlock.md`](../investigations/motor-subsystem-unlock.md),
...
[`cases/performing-rigs/docs/investigations/motor-config-persistence.md`](../investigations/motor-config-persistence.md).
...
use:
[`cases/performing-rigs/docs/investigations/boot-and-hardware-bringup.md`](../investigations/boot-and-hardware-bringup.md)'s
...
[`cases/performing-rigs/docs/investigations/protocol-harness-results.md`](../investigations/protocol-harness-results.md)
...
- The MMIO region (`0x40000000` by default, size configurable) is mapped as
  ...
  **Where a specific bit is a real, SVD-identified, predictably-completing
  ...
  a general peripheral *behavior* model (see `cases/performing-rigs/status.md`'s
