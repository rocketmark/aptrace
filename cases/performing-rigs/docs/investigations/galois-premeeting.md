...
**Background**: `cases/performing-rigs/docs/investigations/trigger-input.md` already documented
...
$EXE explore cases/performing-rigs/research/firmware/originals/firmware_autopilot868.bin 0x4000 0x801c   # low bit clear
$EXE explore cases/performing-rigs/research/firmware/originals/firmware_autopilot868.bin 0x4000 0x801d   # low bit set
```
...
**Background**: `cases/performing-rigs/docs/investigations/protocol-pipeline.md`
...
(`cases/performing-rigs/status.md`'s "Tooling gaps": the narrow fix, if ever
...
```sh
EXE=external/macaw/dist-newstyle/build/*/ghc-9.6.7/aptrace-0.1.0.0/x/aptrace/build/aptrace/aptrace
$EXE debug cases/performing-rigs/research/firmware/originals/firmware_autopilot868.bin 0x888c < /dev/null
```
...
1. **It builds and runs, cleanly, against our real pinned stack** — the
   ...
   (`cases/performing-rigs/docs/investigations/protocol-pipeline.md`) — real
...
(`cases/performing-rigs/docs/investigations/protocol-harness-results.md`) and concretely confirmed
...
(`cases/performing-rigs/docs/investigations/trigger-input.md`). GREASE is analyzing this block
...
6. **Interrupts**: this project's harnesses (Unicorn and Crucible both)
   ...
   `cases/performing-rigs/docs/investigations/boot-and-hardware-bringup.md` — a timer ISR
...
9. **The RF/SPI driver-object boundary**: both AutoPilot and Remote hide
   ...
   `cases/performing-rigs/docs/investigations/boot-and-hardware-bringup.md` and
   `cases/performing-rigs/docs/investigations/protocol-pipeline.md`) — reaching into them
