...
[`census.md`](../../../../docs/tooling/census.md)), which is a Ghidra/Unicorn-driven evidence
...
See [`tool-selection.md`](../../../../docs/tooling/tool-selection.md) for when to reach for Macaw at
...
[`tool-selection.md`](../../../../docs/tooling/tool-selection.md)'s "Tool disagreements" for the
...
- [`tool-selection.md`](../../../../docs/tooling/tool-selection.md) — when to reach for Macaw versus
  Ghidra/Unicorn/Crucible, and the original `0x801c` A32 tool-disagreement
  case this Cortex-M safety work grew out of.
- [`census.md`](../../../../docs/tooling/census.md) — the separate Python/Ghidra/Unicorn evidence
