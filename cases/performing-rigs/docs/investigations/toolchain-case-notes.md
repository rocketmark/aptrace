...
[`cases/performing-rigs/docs/firmware/firmware-layout.md`](../firmware/firmware-layout.md)). It
...
See [`docs/tooling/ghidra-backend.md`](../../../../docs/tooling/ghidra-backend.md) for the
...
See [`docs/tooling/unicorn-backend.md`](../../../../docs/tooling/unicorn-backend.md) for the
...
- No SVD-based MMIO/peripheral register naming yet — a maintained mechanism
  ...
  [`docs/tooling/tool-selection.md`](../../../../docs/tooling/tool-selection.md)'s "SVD /
  MMIO labeling" section.
- Unicorn's MMIO region has no real peripheral behavior (plain
  zero-initialized memory) — see
  [`docs/tooling/unicorn-backend.md`](../../../../docs/tooling/unicorn-backend.md).
